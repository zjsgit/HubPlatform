                ...
                <div class="col-md-9">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a class="menu-top-active" href="viewstatic">Static Network</a></li>
                            <li><a href="viewtemporal">Temporal Network</a></li>
                            <li><a href="viewspatial">Spatial Network</a></li>
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4"  style="padding-left: 0px;">
                            <button class="btn btn-default" id="chageMethod">OK</button>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#updataNumber").click(function(){
        	...
        	$.ajax({ 
                type : "post",
                url : "updatestatic_updateNetwork",
                data : {
                    proteinNumber:number,
                    centralityMethod:method,
